      ...
      <div className="hidden lg:flex lg:w-1/2 bg-brand relative overflow-hidden flex-col justify-between p-12">
        ...
        <div className="relative z-10">
          ...
          <h1 className="text-4xl font-bold text-white leading-tight mb-4">
            Radiology<br />Management Portal
          </h1>
          <p className="text-white/70 text-lg leading-relaxed">
            Upload and manage patient imaging records. Collaborate with the clinical team for AI-assisted breast cancer analysis.
          </p>
        </div>

        <div className="relative z-10 space-y-4">
          {[
            { icon: '🩻', text: 'Upload mammogram & ultrasound images' },
            { icon: '👥', text: 'Manage patient records securely' },
