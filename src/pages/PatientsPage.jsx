    ...
    <PageLayout>
      ...
      <div className="relative mb-6">
        ...
        <input
          ...
          className="w-full pl-11 pr-10 py-3 bg-white border border-gray-200 rounded-xl text-sm focus:outline-none focus:ring-2 focus:ring-rose-300 focus:border-transparent shadow-card placeholder:text-gray-400 transition-all"
        />
        {search && (
          <button
            onClick={() => setSearch('')}
            className="absolute right-4 top-1/2 -translate-y-1/2 w-5 h-5 flex items-center justify-center text-gray-400 hover:text-gray-600 bg-gray-100 rounded-full text-xs transition-colors"
          >
            ✕
          </button>
        )}
    ...
    >
      ...
      <div className="flex items-center gap-3 mb-4">
        ...
        <div className="flex-1 min-w-0">
          <p className="font-bold text-gray-900 truncate group-hover:text-rose-600 transition-colors text-sm">
            {p.name}
          </p>
          <p className="text-gray-400 text-xs mt-0.5">{date}</p>
        </div>
        <div className="w-7 h-7 rounded-lg bg-gray-50 group-hover:bg-rose-50 flex items-center justify-center transition-colors flex-shrink-0">
